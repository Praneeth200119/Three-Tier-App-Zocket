...
const LoginUser = () => {
  return (
    <>
    <div style={{backgroundColor:'lightblue', height:'400px',width:'400px', display:'flex', justifyContent:'center',marginLeft:'400px'}}>
  ...
  <h1 className="text-base font-semibold leading-7 text-gray-900">Sign in as User</h1>
